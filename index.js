...
app.get('/', (req, res) => {
    ...
    <html>
    <head>
    <link rel="icon" href="https://raw.githubusercontent.com/cvera08/ClimateChangeAPIDevelopmentNodeJsExpressAxios/herokumaster/data/favicon.ico"> <!-- image of the tab -->
